...
> = {
  ...
  reprogramado: {
    ...
    chip: 'bg-amber-50 text-amber-700 ring-amber-200 dark:bg-amber-950/40 dark:text-amber-300 dark:ring-amber-800/60',
    punto: 'bg-amber-500',
  ...
  ausente: {
    etiqueta: 'Ausente',
    chip: 'bg-rose-50 text-rose-700 ring-rose-200 dark:bg-rose-950/40 dark:text-rose-300 dark:ring-rose-800/60',
    punto: 'bg-rose-500',
...
export const TIPOS_SESION: TipoSesion[] = [
  {
    ...
    grupo: GRUPO_INGRESO,
    chip: 'bg-violet-50 text-violet-700 ring-violet-200 dark:bg-violet-950/40 dark:text-violet-300 dark:ring-violet-800/60',
    punto: 'bg-violet-500',
  ...
  },
  {
    ...
    grupo: GRUPO_INGRESO,
    chip: 'bg-purple-50 text-purple-700 ring-purple-200 dark:bg-purple-950/40 dark:text-purple-300 dark:ring-purple-800/60',
    punto: 'bg-purple-500',
...

  {
    ...
    grupo: GRUPO_TRAUMA,
    chip: 'bg-fuchsia-50 text-fuchsia-700 ring-fuchsia-200 dark:bg-fuchsia-950/40 dark:text-fuchsia-300 dark:ring-fuchsia-800/60',
  ...
  },
  {
    ...
    grupo: GRUPO_TRAUMA,
    chip: 'bg-orange-50 text-orange-700 ring-orange-200 dark:bg-orange-950/40 dark:text-orange-300 dark:ring-orange-800/60',
    punto: 'bg-orange-500',
  ...
  },
  {
    ...
    grupo: GRUPO_TRAUMA,
    chip: 'bg-pink-50 text-pink-700 ring-pink-200 dark:bg-pink-950/40 dark:text-pink-300 dark:ring-pink-800/60',
    punto: 'bg-pink-500',
  ...
  },
  {
    ...
    grupo: GRUPO_TRAUMA,
    chip: 'bg-red-50 text-red-700 ring-red-200 dark:bg-red-950/40 dark:text-red-300 dark:ring-red-800/60',
    punto: 'bg-red-500',
...

  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-sky-50 text-sky-700 ring-sky-200 dark:bg-sky-950/40 dark:text-sky-300 dark:ring-sky-800/60',
    punto: 'bg-sky-500',
  ...
  },
  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-cyan-50 text-cyan-700 ring-cyan-200 dark:bg-cyan-950/40 dark:text-cyan-300 dark:ring-cyan-800/60',
    punto: 'bg-cyan-500',
  ...
  },
  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-emerald-50 text-emerald-700 ring-emerald-200 dark:bg-emerald-950/40 dark:text-emerald-300 dark:ring-emerald-800/60',
  ...
  },
  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-indigo-50 text-indigo-700 ring-indigo-200 dark:bg-indigo-950/40 dark:text-indigo-300 dark:ring-indigo-800/60',
    punto: 'bg-indigo-500',
  ...
  },
  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-teal-50 text-teal-700 ring-teal-200 dark:bg-teal-950/40 dark:text-teal-300 dark:ring-teal-800/60',
    punto: 'bg-teal-500',
  ...
  },
  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-blue-50 text-blue-700 ring-blue-200 dark:bg-blue-950/40 dark:text-blue-300 dark:ring-blue-800/60',
    punto: 'bg-blue-500',
  ...
  },
  {
    ...
    grupo: GRUPO_OTRAS,
    chip: 'bg-lime-50 text-lime-800 ring-lime-200 dark:bg-lime-950/40 dark:text-lime-300 dark:ring-lime-800/60',
    punto: 'bg-lime-500',
